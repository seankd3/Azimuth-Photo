...
| 2026-07-25 BUG-PREGEN-WATCHDOG-01 on `7ad2d5f3` | Preview stall-watchdog truth | Before: exact node failed 1/1 and reset the executor twice while a decode heartbeat advanced every 50 ms. After: exact node passed 10/10 with zero false resets; the true-stall/progress pair passed 2 tests; related preview/pregeneration coverage passed 62 tests; Ruff and quick green | Preserve true-stall recovery and prove one real workload longer than the five-minute production stall window; confirm closure in the next complete gate | `done awaiting integration` |
...
| BUG-PREGEN-WATCHDOG-01 | `sprint-integration` / `7ad2d5f3` | Watchdog staleness follows the newest generation, progress-heartbeat, or start timestamp | Exact progressing fixture 10/10, true-stall/progress pair 2 passed, preview/pregeneration matrix 62 passed, Ruff/quick green; full-order rerun pending |
