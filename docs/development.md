...
| V2 Trash and restore | `web/model/trash.py`, `web/static/v2/shell/trash.js` | Trash is a reversible identity decision; Empty Trash alone deletes fully reverified copies behind an exact typed-count gate. |
