...
| V2 Pick, Reject, Trash, and restore | `web/model/cull.py`, `web/model/trash.py`, `web/static/v2/shell/` | Culling is one reversible identity decision; Empty Trash alone deletes fully reverified copies behind an exact typed-count gate. |
