...
| `web/boot.py` | Rebuilt | Verification and fresh boot | `e331be8f`, `155d450c` | One owned `Library` adds embedded details and capture-date correction to explicit attach/refresh, browse, tile, debt, worker, and deterministic close; boot repairs projected metadata indexes from cache |
