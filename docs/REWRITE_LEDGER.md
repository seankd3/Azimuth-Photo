...
| `scripts/gates/invokes.py` | Removed | Verification | `e757a6fe`, `416f1c74` | The workflow-path check left with the workflows it checked; `scripts/gates/paths.py` keeps the one rule that matters for agents -- a guide may not name a path that is not there |
