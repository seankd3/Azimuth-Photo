...
export const GUIDED_RADIUS_FRACTION = 0.04;
export const GUIDED_FEATHERING_MIN = 10.0;
export const GUIDED_FEATHERING_RANGE = 990.0;
export const GUIDED_EPSILON_DEFAULT = 0.003;
export const GUIDED_DEFAULT_FEATHER = 0.5;
export const GUIDED_GAUSSIAN_SIGMA_SCALE = 0.5;
export const GUIDED_FAST_SUBSAMPLE = 4;
export const GUIDED_FAST_MIN_SIDE = 64;
...
export const PARITY_TABLE = Object.freeze({
    ...
    GUIDED_RADIUS_FRACTION, GUIDED_FEATHERING_MIN, GUIDED_FEATHERING_RANGE,
    GUIDED_EPSILON_DEFAULT, GUIDED_DEFAULT_FEATHER, GUIDED_GAUSSIAN_SIGMA_SCALE,
    GUIDED_FAST_SUBSAMPLE, GUIDED_FAST_MIN_SIDE,
