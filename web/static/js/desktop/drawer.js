...
function renderDrawer() {
    ...
    body.innerHTML = renderSources() + renderLibraryHealth(catalog) + renderWork() + renderSharedHome() + renderDevices() + renderConnectServer() + renderFreeUp() + renderSettingsSections() + renderStorage() + renderRemote() + renderPrefs() + renderAbout() + renderSettingsSaveBar();
    updateDrawerContext();
    bindDrawerActions();
