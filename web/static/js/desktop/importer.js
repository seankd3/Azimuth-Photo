...
function modalHtml() {
    return '<div id="import-modal" class="modal-card" role="dialog" aria-modal="true" aria-label="Import photos" tabindex="-1">'
        ...
        + '<input id="import-file-input" type="file" multiple hidden><input id="import-folder-input" type="file" webkitdirectory directory multiple hidden>'
        ...
        + '<label class="check"><input id="import-preserve-structure" type="checkbox"> Preserve folder structure</label>'
        + '</div>'
