...
export const SHORTCUTS = [
    ...
    { area: 'Library', key: 'C / O / M / H', label: 'Collections / People / Map / Shared' },
    ...
    { area: 'Library', key: '1–5', label: 'Filter by stars (never rates)' },
    { area: 'Library', key: 'B', label: 'Toggle Best Of' },
    { area: 'Library', key: 'F', label: 'Fullscreen' },
    { area: 'Library', key: 'Shift F', label: 'Open filters' },
