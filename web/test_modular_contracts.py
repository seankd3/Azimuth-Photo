...
class ModularContractTests(unittest.TestCase):
    ...
    def test_core_response_helpers_back_app_facades(self):
        responses = importlib.import_module("core.responses")
        request_helpers = importlib.import_module("core.requests")
        helpers = importlib.import_module("helpers")

        self.assertIs(app_module._interaction_pool_stats, responses.interaction_pool_stats)
        self.assertIs(app_module._compare_response_rows, responses.compare_response_rows)
        self.assertIs(app_module._copy_interaction_response, responses.copy_interaction_response)
        self.assertIs(app_module._visibility_counts, responses.visibility_counts)
        self.assertIs(app_module._positive_int, request_helpers.positive_int)
        self.assertIs(app_module._clamp_int, request_helpers.clamp_int)
        self.assertIs(app_module._json_object, request_helpers.json_object)
        self.assertIs(app_module._ranking_signal_count, helpers.ranking_signal_count)
        self.assertIs(app_module._has_ranking_signal, helpers.has_ranking_signal)
        self.assertIs(app_module._camera_label, helpers.camera_label)
        self.assertIs(app_module._metadata_payload, responses.metadata_payload)
        ...
        self.assertIs(app_module._chunks, helpers._chunks)
        self.assertIs(app_module._filter_by_metadata, helpers.filter_by_metadata)
        ...
        self.assertEqual(
            app_module._visibility_counts(5, 3),
    ...
    def test_library_service_backs_app_rankings_facades(self):
        ...
        self.assertIs(app_module._copy_rankings_response, service.copy_rankings_response)
        self.assertIs(app_module._cache_rankings_response, service.cache_rankings_response)
