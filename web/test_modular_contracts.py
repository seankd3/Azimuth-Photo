...
PUBLIC_ROUTE_CONTRACT = {
    ...
    ("GET", "/api/stats"),
    ("GET", "/api/stacks"),
    ("GET", "/api/stacks/identical"),
    ("GET", "/api/stacks/identical/status"),
    ("GET", "/api/stacks/identical/summary"),
    ("GET", "/api/stacks/rebuild/status"),
    ("GET", "/api/stacks/representatives"),
    ("GET", "/api/stacks/{stack_id}"),
    ("POST", "/api/stacks"),
    ("POST", "/api/stacks/rebuild"),
    ("POST", "/api/stacks/identical/verify"),
    ("POST", "/api/stacks/identical/cleanup"),
    ...
    ("POST", "/api/sync/now"),
    ("GET", "/api/sync/freeable"),
    ("POST", "/api/sync/freeup"),
    ("GET", "/api/sync/freeup/{job_id}"),
    ("POST", "/api/sync/freeup/{job_id}/cancel"),
    ...
    ("GET", "/api/backup/cloud/remotes"),
    ("GET", "/api/backup/cloud/config"),
    ("PUT", "/api/backup/cloud/config"),
    ...
    ("POST", "/api/lr/deltas"),
    ("POST", "/api/lr/exports"),
    ("GET", "/api/lr/relation/{image_id}"),
    ("GET", "/api/lr/connect"),
    ("POST", "/api/lr/connect"),
    ("DELETE", "/api/lr/connect"),
