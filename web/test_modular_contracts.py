...
class ModularContractTests(unittest.TestCase):
    ...
    def test_data_layer_modules_back_legacy_facades(self):
        ...
        repository_common = importlib.import_module("data.repositories.common")
        ...
        self.assertIs(rankings._chunked, repository_common.chunked)
        ...
        self.assertTrue(callable(cache_events.invalidate_cached_image_ids_cache))
        self.assertTrue(callable(cache_events.note_cached_image_ids_added))
        ...
        self.assertTrue(callable(cache_events.invalidate_filter_options_cache))
        self.assertTrue(callable(cache_events.clear_filter_options_cache))
        ...
        self.assertTrue(callable(cache_events.invalidate_past_matchups_cache))
        ...
        self.assertTrue(callable(cache_events.invalidate_facet_caches))
        self.assertTrue(callable(cache_events.invalidate_visible_facet_caches))
        self.assertTrue(callable(cache_events.invalidate_rating_facet_caches))
        self.assertTrue(callable(cache_events.invalidate_visible_cache_dependent_counts))
        self.assertTrue(callable(cache_events.invalidate_rating_ranking_count_cache))
        ...
        self.assertIs(cache_events.cache_scope_matches, rankings.cache_scope_matches)
        ...
        self.assertTrue(callable(cache_events.invalidate_active_source_ids_cache))
        ...
        self.assertTrue(callable(cache_events.invalidate_catalog_cache))
        self.assertTrue(callable(cache_events.invalidate_catalog_summary_cache))
    ...
    def test_frontend_module_bootstrap_preserves_global_contract(self):
        ...
        self.assertIn("export const MOSAIC_NEIGHBOR_LIMIT", compare_query)
        self.assertIn("export const COMPARE_NEIGHBOR_PAIRS", compare_query)
        ...
        self.assertIn("export const LIBRARY_NEIGHBOR_LIMIT", library_pagination)
        ...
        self.assertIn("export const SORT_STORAGE_KEY", library_search_state)
        self.assertIn("export const SEARCH_STORAGE_KEY", library_search_state)
        self.assertIn("export const SEARCH_SORT_STORAGE_KEY", library_search_state)
        self.assertIn("export const SEARCH_DEEP_STORAGE_KEY", library_search_state)
        ...
        self.assertIn("export const SCROLL_POS_STORAGE_KEY", library_shell)
        self.assertIn("export const SCROLL_OFFSET_STORAGE_KEY", library_shell)
        ...
        self.assertIn("export const DEFAULT_CROSS_VIEW_WARM_DELAY_MS", warmup_neighbors)
...
"""
    ...
    def test_thumbnail_package_exposes_config_slice(self):
        ...
        jobs = importlib.import_module("thumbnails.jobs")
        ...
        self.assertTrue(callable(jobs.get_thumbnail))
        self.assertTrue(callable(jobs.prefetch_images))
