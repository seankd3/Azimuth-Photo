...
def _configure_database_backed_providers() -> None:
    import db
    import embed_cache
...
def _configure_people_routes() -> None:
    import db
...
def _configure_status_media_search_providers() -> None:
    import db
    import thumbnails
...
def _configure_cache_events() -> None:
    import db
    import elo_propagation
...
def _configure_catalog_routes() -> None:
    import db
...
def _configure_library_routes() -> None:
    from features.library import service as library_service
...
def _configure_search_routes() -> None:
    import db
    from core import cache_events, query_constraints
...
def create_app_shell(
    *,
    ...
    _configure_database_backed_providers()
    _configure_people_routes()
    _configure_status_media_search_providers()
    _configure_cache_events()
    _configure_catalog_routes()
    _configure_library_routes()
    _configure_search_routes()
