...
orchestration. `jobs.py` owns thumbnail cache-presence checks plus request and
prefetch scheduling helpers that are wired to active executors and caches by
