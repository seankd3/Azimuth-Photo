...
from pixels.ramps import smoothstep as _smoothstep, gaussian_ev as _gaussian_ev

from pixels.numbers import setting as _number
...
def apply_pipeline(
    ...
    *,
    ...
    if film_stock:
        ...
        from pixels import sigmoid_view
