...
async def _search(query: str, mode: str, limit: int) -> tuple[list[dict], dict]:
    ...
    if mode == "embedding":
        ...
        result = await query_constraints.resolve_text_search(
            ...
            get_search_query_embedding=query_constraints.get_catalog_search_query_embedding,
            store_search_query_embedding=query_constraints.store_catalog_search_query_embedding,
