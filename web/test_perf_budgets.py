...
def perf_catalog():
    ...
    old_prefetch = library_service._configured_schedule_thumbnail_prefetch
    old_memory_warm = library_service._configured_schedule_result_thumbnail_memory_warm
    ...
    library_service._configured_schedule_thumbnail_prefetch = no_prefetch
    library_service._configured_schedule_result_thumbnail_memory_warm = lambda *_args, **_kwargs: None
    _clear_query_caches()
    ...
    try:
        ...
        client.close()
        library_service._configured_schedule_thumbnail_prefetch = old_prefetch
        library_service._configured_schedule_result_thumbnail_memory_warm = old_memory_warm
